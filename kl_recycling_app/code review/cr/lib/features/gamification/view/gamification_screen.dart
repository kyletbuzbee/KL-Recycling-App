...
import 'package:kl_recycling_app/core/widgets/lottie_animations.dart';
import 'package:kl_recycling_app/features/notifications/view/notification_settings_screen.dart';
import 'package:kl_recycling_app/features/challenges/view/challenges_screen.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: AppIconTile(
              assetPath: AppIcons.notificationSettings,
        ...
        bottom: TabBar(
          ...
          unselectedLabelColor: AppColors.onSurfaceSecondary.withValues(alpha: 0.7),
          tabs: [
            Tab(
              text: 'Dashboard',
              icon: AppIconTile(
            ...
            Tab(
              text: 'History',
              icon: AppIconTile(
                assetPath: AppIcons.inventoryManagement,
            ...
            Tab(
              text: 'Challenges',
            icon: AppIconTile(
              assetPath: AppIcons.achievementsGallery,
              semanticLabel: 'Challenges tab',
              width: 24,
              height: 24,
            ),
            ),
                ...
                child: Column(
                  ...
                  children: [
                    Icon(
                      Icons.history,
                      size: 80,
                      color: AppColors.onSurfaceSecondary.withAlpha(128),
                    ),
                    const SizedBox(height: 16),
                    Text(
      ...
      Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            AppAnimations.fadeIn(
              Text(
                'Complete challenges to earn bonus points and unlock special achievements!',
                textAlign: TextAlign.center,
                style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                  color: AppColors.onSurfaceSecondary,
                ),
                ...
                children: [
                  ...
                  if (!isEarned)
                    Icon(
                      Icons.lock,
                      size: 20,
                      color: AppColors.onSurfaceSecondary.withAlpha(178),
                    ),
                ],
              ),
              const SizedBox(height: 12),
