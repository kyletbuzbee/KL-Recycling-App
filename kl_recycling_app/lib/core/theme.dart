...
class AppTheme {
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    // Typography - Enhanced for better readability and visual hierarchy
    textTheme: const TextTheme(
      displayLarge: TextStyle(
        fontSize: 57,
        fontWeight: FontWeight.w700, // Bolder for display
        height: 1.12,
      ...
      displayMedium: TextStyle(
        ...
        height: 1.15, // Better line height
        letterSpacing: -0.25,
      ),
      displaySmall: TextStyle(
        fontSize: 36,
        fontWeight: FontWeight.w600, // Bolder for hero text
        height: 1.15,
        letterSpacing: -0.25,
      ),
      headlineLarge: TextStyle(
        fontSize: 32,
        fontWeight: FontWeight.w700, // Much bolder for section headers
        height: 1.25,
        letterSpacing: -0.5, // Improved tracking
      ),
      headlineMedium: TextStyle(
        fontSize: 28,
        fontWeight: FontWeight.w700, // Much bolder for headers
        height: 1.29,
        letterSpacing: -0.25,
      ),
      ...
      titleLarge: TextStyle(
        fontSize: 22,
        fontWeight: FontWeight.w600, // Bolder titles
        height: 1.27,
        letterSpacing: -0.15,
      ),
      titleMedium: TextStyle(
        fontSize: 16,
        fontWeight: FontWeight.w600, // Bolder medium titles
        height: 1.50,
        letterSpacing: 0.25, // Improved letter spacing
      ),
      titleSmall: TextStyle(
        fontSize: 14,
        fontWeight: FontWeight.w600, // Bolder small titles
        height: 1.43,
        letterSpacing: 0.15,
      ),
      bodyLarge: TextStyle(
        ...
        height: 1.65, // Improved line height for body text
        letterSpacing: 0.25, // Better letter spacing
      ),
      bodyMedium: TextStyle(
        fontSize: 14,
        fontWeight: FontWeight.w500, // Slightly bolder
        height: 1.55, // Improved line height
        letterSpacing: 0.15,
      ),
      bodySmall: TextStyle(
        fontSize: 12,
      ...
      labelLarge: TextStyle(
        fontSize: 14,
        fontWeight: FontWeight.w700, // Much bolder for buttons
        height: 1.43,
        letterSpacing: 0.25,
      ),
